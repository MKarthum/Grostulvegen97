...
export const en: Translation = {
  ...
  videos: [
    {
      id: "water-on",
      title: "How to open the water",
      description: "Step by step video showing how to turn on the water supply when you arrive.",
      url: "",
    },
    {
      id: "water-off",
      title: "How to shut off the water",
      description: "Step by step video showing how to turn off the water supply before you leave.",
      url: "",
    },
    {
      id: "heating-ventilation",
      title: "Heating and ventilation",
      description: "How to control the heaters, floor heating, and ventilation in the cabin.",
      url: "",
    },
    {
      id: "departure-checklist",
      title: "Departure checklist",
      description: "A walkthrough of the checklist routines, filmed at the cabin.",
      url: "",
    },
  ],
  contact: {
